...
(function(e) {
  ...
  e.exports = u, u.eastAsianWidth = function(t) {
    var s2 = t.charCodeAt(0), i = t.length == 2 ? t.charCodeAt(1) : 0, D = s2;
  ...
  u.length = function(t) {
    ...
    return i;
  }, u.slice = function(t, s2, i) {
    textLen = u.length(t), s2 = s2 || 0, i = i || 1, s2 < 0 && (s2 = textLen + s2), i < 0 && (i = textLen + i);
    for (var D = "", C = 0, o = F(t), E = 0; E < o.length; E++) {
      var a = o[E], n = u.length(a);
      if (C >= s2 - (n == 2 ? 1 : 0)) if (C + n <= i) D += a;
      else break;
      C += n;
    }
    return D;
...
var FD = O(uD);
function p(e, u = {}) {
  if (typeof e != "string" || e.length === 0 || (u = { ambiguousIsNarrow: true, ...u }, e = T(e), e.length === 0)) return 0;
  e = e.replace(FD(), "  ");
...
var m = 10;
var L = (e = 0) => (u) => `\x1B[${u + e}m`;
var W = (e = 0) => (u) => `\x1B[${38 + e};5;${u}m`;
var N = (e = 0) => (u, F, t) => `\x1B[${38 + e};2;${u};${F};${t}m`;
...
function sD() {
  ...
  return Object.defineProperty(r, "codes", { value: e, enumerable: false }), r.color.close = "\x1B[39m", r.bgColor.close = "\x1B[49m", r.color.ansi = L(), r.color.ansi256 = W(), r.color.ansi16m = N(), r.bgColor.ansi = L(m), r.bgColor.ansi256 = W(m), r.bgColor.ansi16m = N(m), Object.defineProperties(r, { rgbToAnsi256: { value: (u, F, t) => u === F && F === t ? u < 8 ? 16 : u > 248 ? 231 : Math.round((u - 8) / 247 * 24) + 232 : 16 + 36 * Math.round(u / 255 * 5) + 6 * Math.round(F / 255 * 5) + Math.round(t / 255 * 5), enumerable: false }, hexToRgb: { value: (u) => {
    ...
    if (u >= 232) F = ((u - 232) * 10 + 8) / 255, t = F, s2 = F;
      ...
      u -= 16;
      const C = u % 36;
      F = Math.floor(u / 36) / 5, t = Math.floor(C / 6) / 5, s2 = C % 6 / 5;
    }
    const i = Math.max(F, t, s2) * 2;
    if (i === 0) return 30;
...
var R = "m";
var y = `${rD}8;;`;
var V = (e) => `${v.values().next().value}${I}${e}${R}`;
var z = (e) => `${v.values().next().value}${y}${e}${w}`;
var ED = (e) => e.split(" ").map((u) => p(u));
var _ = (e, u, F) => {
  const t = [...u];
  let s2 = false, i = false, D = p(T(e[e.length - 1]));
  for (const [C, o] of t.entries()) {
    const E = p(o);
    if (D + E <= F ? e[e.length - 1] += o : (e.push(o), D = 0), v.has(o) && (s2 = true, i = t.slice(C + 1).join("").startsWith(y)), s2) {
      i ? o === w && (s2 = false, i = false) : o === R && (s2 = false);
      continue;
    }
...
function k(e, u) {
  if (typeof e == "string") return A.aliases.get(e) === u;
...
var pD = (e, u, F) => u in e ? AD(e, u, { enumerable: true, configurable: true, writable: true, value: F }) : e[u] = F;
var l = (e, u, F) => (pD(e, typeof u != "symbol" ? u + "" : u, F), F);
var x = class {
  constructor(u, F = true) {
    ...
    const { input: t = stdin, output: s2 = stdout, render: i, signal: D, ...C } = u;
    this.opts = C, this.onKeypress = this.onKeypress.bind(this), this.close = this.close.bind(this), this.render = this.render.bind(this), this._render = i.bind(this), this._track = F, this._abortSignal = D, this.input = t, this.output = s2;
  }
  unsubscribe() {
  ...
  emit(u, ...F) {
    const t = this._subscribers.get(u) ?? [], s2 = [];
    for (const i of t) i.cb(...F), i.once && s2.push(() => t.splice(t.indexOf(i), 1));
    for (const i of s2) i();
  }
  prompt() {
    ...
    if (u !== this._prevFrame) {
      if (this.state === "initial") this.output.write(srcExports.cursor.hide);
        ...
        if (this.restoreCursor(), F && F?.length === 1) {
          ...
          const s2 = u.split(`
`);
          this.output.write(s2[t]), this._prevFrame = u, this.output.write(srcExports.cursor.move(0, s2.length - t - 1));
          return;
        }
        if (F && F?.length > 1) {
          const t = F[0];
...
var mD = (e, u, F) => u in e ? bD(e, u, { enumerable: true, configurable: true, writable: true, value: F }) : e[u] = F;
var Y = (e, u, F) => (mD(e, typeof u != "symbol" ? u + "" : u, F), F);
...
var SD = (e, u, F) => u in e ? $D(e, u, { enumerable: true, configurable: true, writable: true, value: F }) : e[u] = F;
var q = (e, u, F) => (SD(e, typeof u != "symbol" ? u + "" : u, F), F);
...
var LD = (e, u, F) => u in e ? PD(e, u, { enumerable: true, configurable: true, writable: true, value: F }) : e[u] = F;
var WD = (e, u, F) => (LD(e, u + "", F), F);
var ND = class extends x {
  constructor(u) {
    super(u), WD(this, "valueWithCursor", ""), this.on("finalize", () => {
      this.value || (this.value = u.defaultValue), this.valueWithCursor = this.value;
    }), this.on("value", () => {
      if (this.cursor >= this.value.length) this.valueWithCursor = `${this.value}${c.inverse(c.hidden("_"))}`;
      else {
